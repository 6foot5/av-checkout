	...
	<cfif ListContains(cookie.userAdminType,"globalAdmin") NEQ 0>
		...
		<cfoutput>
		<option value="dbview.cfm?type=cats&deptID=all" #isSelected#>&nbsp;View Reservations for All Departments&nbsp;&nbsp;</option>
		</cfoutput>
	</cfif>
	...
	<cfoutput query="get_depts">
		...
		<option value="dbview.cfm?type=#contentType#&deptID=#DEPT_ID#" #isSelected#>&nbsp;View Reservations for #DEPT_NAME#&nbsp;&nbsp;</option>
	</cfoutput>
