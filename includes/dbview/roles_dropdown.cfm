	...
	<cfif ListContains(cookie.userAdminType,"globalAdmin") NEQ 0>
		...
		<cfoutput>
		<option value="dbview.cfm?type=roles&deptID=all" #isSelected#>&nbsp;View Roles for All Departments&nbsp;&nbsp;</option>
		</cfoutput>
	</cfif>
	...
	<cfoutput query="get_depts">
		...
		<option value="dbview.cfm?type=#contentType#&deptID=#DEPT_ID#" #isSelected#>&nbsp;View Roles for #DEPT_NAME#&nbsp;&nbsp;</option>
	</cfoutput>
